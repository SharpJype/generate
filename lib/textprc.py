...
def string_unicode(x:str) -> hex: # generate hex from string
    for xx in x: yield hex(ord(xx))
def char_unicode(x:str) -> hex: return hex(ord(x))
def unicode_char(x) -> str:
    if type(x) is hex: x = int(x, 16)
    return chr(x)
def random_unicode(length=4): return chr(random.randint(0,16**min(length, 4)))
...
VOWELS_ASCII = "aeiouy"
CONSONANTS_ASCII = "bdfghjklmnprstvqz"
def listpick(l, n=1):
    picks = []
    while len(l)>0 and len(picks)<n: picks.append(l.pop(random.randint(0,len(l)-1)))
    return picks
def artificialword_settings(soft=VOWELS_ASCII, hard=CONSONANTS_ASCII, special=CONSONANTS_ASCII):
    if not soft: soft = VOWELS_ASCII
    elif type(soft)==int: soft = "".join(listpick(list(VOWELS_ASCII), min(soft, len(VOWELS_ASCII))))
    if not hard: hard = CONSONANTS_ASCII
    elif type(hard)==int: hard = "".join(listpick(list(CONSONANTS_ASCII), min(hard, len(CONSONANTS_ASCII))))
    if not special: special = CONSONANTS_ASCII
    elif type(special)==int: special = "".join(listpick(list(CONSONANTS_ASCII), min(special, len(CONSONANTS_ASCII))))
    return soft, hard, special
def artificialword(segments, soft=VOWELS_ASCII, hard=CONSONANTS_ASCII, special=CONSONANTS_ASCII):
...
CHARACTER_FREQUENCIES["en"] = [('a', 8167), ('b', 1492), ('c', 2782), ('d', 4253), ('e', 12702), ('f', 2228), ('g', 2015), ('h', 6094), ('i', 6966), ('j', 153), ('k', 772), ('l', 4025), ('m', 2406), ('n', 6749), ('o', 7507), ('p', 1929), ('q', 95), ('r', 5987), ('s', 6327), ('t', 9056), ('u', 2758), ('v', 978), ('w', 2360), ('x', 150), ('y', 1974), ('z', 74)]
CHARACTER_FREQUENCIES["fr"] = [('a', 7636), ('b', 901), ('c', 3260), ('d', 3669), ('e', 14715), ('f', 1066), ('g', 866), ('h', 737), ('i', 7529), ('j', 613), ('k', 74), ('l', 5456), ('m', 2968), ('n', 7095), ('o', 5796), ('p', 2521), ('q', 1362), ('r', 6693), ('s', 7948), ('t', 7244), ('u', 6311), ('v', 1838), ('w', 49), ('x', 427), ('y', 128), ('z', 326), ('à', 486), ('â', 51), ('œ', 18), ('ç', 85), ('è', 271), ('é', 1504), ('ê', 218), ('ë', 8), ('î', 45), ('ï', 5), ('ô', 23), ('ù', 58), ('û', 60)]
CHARACTER_FREQUENCIES["de"] = [('a', 6516), ('b', 1886), ('c', 2732), ('d', 5076), ('e', 16396), ('f', 1656), ('g', 3009), ('h', 4577), ('i', 6550), ('j', 268), ('k', 1417), ('l', 3437), ('m', 2534), ('n', 9776), ('o', 2594), ('p', 670), ('q', 18), ('r', 7003), ('s', 7270), ('t', 6154), ('u', 4166), ('v', 846), ('w', 1921), ('x', 34), ('y', 39), ('z', 1134), ('ä', 578), ('ö', 443), ('ß', 307), ('ü', 995)]
CHARACTER_FREQUENCIES["es"] = [('a', 11525), ('b', 2215), ('c', 4019), ('d', 5010), ('e', 12181), ('f', 692), ('g', 1768), ('h', 703), ('i', 6247), ('j', 493), ('k', 11), ('l', 4967), ('m', 3157), ('n', 6712), ('o', 8683), ('p', 2510), ('q', 877), ('r', 6871), ('s', 7977), ('t', 4632), ('u', 2927), ('v', 1138), ('w', 17), ('x', 215), ('y', 1008), ('z', 467), ('á', 502), ('é', 433), ('í', 725), ('ñ', 311), ('ó', 827), ('ú', 168), ('ü', 12)]
CHARACTER_FREQUENCIES["pt"] = [('a', 14634), ('b', 1043), ('c', 3882), ('d', 4992), ('e', 12570), ('f', 1022), ('g', 1303), ('h', 781), ('i', 6186), ('j', 397), ('k', 15), ('l', 2779), ('m', 4738), ('n', 4446), ('o', 9735), ('p', 2523), ('q', 1204), ('r', 6530), ('s', 6805), ('t', 4336), ('u', 3639), ('v', 1575), ('w', 37), ('x', 253), ('y', 6), ('z', 470), ('à', 72), ('â', 562), ('á', 118), ('ã', 733), ('ç', 530), ('é', 337), ('ê', 450), ('í', 132), ('ô', 635), ('ó', 296), ('õ', 40), ('ú', 207), ('ü', 26)]
CHARACTER_FREQUENCIES["eo"] = [('a', 12117), ('b', 980), ('c', 776), ('d', 3044), ('e', 8995), ('f', 1037), ('g', 1171), ('h', 384), ('i', 10012), ('j', 3501), ('k', 4163), ('l', 6104), ('m', 2994), ('n', 7955), ('o', 8779), ('p', 2755), ('r', 5914), ('s', 6092), ('t', 5276), ('u', 3183), ('v', 1904), ('z', 494), ('ĉ', 657), ('ĝ', 691), ('ĥ', 22), ('ĵ', 55), ('ŝ', 385), ('ŭ', 520)]
CHARACTER_FREQUENCIES["it"] = [('a', 11745), ('b', 927), ('c', 4501), ('d', 3736), ('e', 11792), ('f', 1153), ('g', 1644), ('h', 636), ('i', 10143), ('j', 11), ('k', 9), ('l', 6510), ('m', 2512), ('n', 6883), ('o', 9832), ('p', 3056), ('q', 505), ('r', 6367), ('s', 4981), ('t', 5623), ('u', 3011), ('v', 2097), ('w', 33), ('x', 3), ('y', 20), ('z', 1181), ('à', 635), ('è', 263), ('ì', 30), ('í', 30), ('ò', 2), ('ù', 166), ('ú', 166)]
CHARACTER_FREQUENCIES["tr"] = [('a', 11920), ('b', 2844), ('c', 963), ('d', 4706), ('e', 8912), ('f', 461), ('g', 1253), ('h', 1212), ('i', 8600), ('j', 34), ('k', 4683), ('l', 5922), ('m', 3752), ('n', 7487), ('o', 2476), ('p', 886), ('r', 6722), ('s', 3014), ('t', 3314), ('u', 3235), ('v', 959), ('y', 3336), ('z', 1500), ('ç', 1156), ('ğ', 1125), ('ı', 5114), ('ö', 777), ('ş', 1780), ('ü', 1854)]
CHARACTER_FREQUENCIES["se"] = [('a', 9383), ('b', 1535), ('c', 1486), ('d', 4702), ('e', 10149), ('f', 2027), ('g', 2862), ('h', 2090), ('i', 5817), ('j', 614), ('k', 3140), ('l', 5275), ('m', 3471), ('n', 8542), ('o', 4482), ('p', 1839), ('q', 20), ('r', 8431), ('s', 6590), ('t', 7691), ('u', 1919), ('v', 2415), ('w', 142), ('x', 159), ('y', 708), ('z', 70), ('å', 1340), ('ä', 1800), ('ö', 1310)]
CHARACTER_FREQUENCIES["pl"] = [('a', 8965), ('b', 1482), ('c', 3988), ('d', 3293), ('e', 7921), ('f', 312), ('g', 1377), ('h', 1072), ('i', 8286), ('j', 2343), ('k', 3411), ('l', 2136), ('m', 2911), ('n', 5600), ('o', 7590), ('p', 3101), ('q', 3), ('r', 4571), ('s', 4263), ('t', 3966), ('u', 2347), ('v', 34), ('w', 4549), ('x', 19), ('y', 3857), ('z', 5620), ('ą', 1020), ('ć', 448), ('ę', 1131), ('ł', 1746), ('ń', 185), ('ó', 823), ('ś', 683), ('ź', 61), ('ż', 885)]
CHARACTER_FREQUENCIES["nl"] = [('a', 7490), ('b', 1580), ('c', 1240), ('d', 5930), ('e', 18910), ('f', 810), ('g', 3400), ('h', 2380), ('i', 6500), ('j', 1460), ('k', 2250), ('l', 3570), ('m', 2210), ('n', 10030), ('o', 6060), ('p', 1570), ('q', 9), ('r', 6410), ('s', 3730), ('t', 6790), ('u', 1990), ('v', 2850), ('w', 1520), ('x', 36), ('y', 35), ('z', 1390)]
CHARACTER_FREQUENCIES["da"] = [('a', 6025), ('b', 2000), ('c', 565), ('d', 5858), ('e', 15453), ('f', 2406), ('g', 4077), ('h', 1621), ('i', 6000), ('j', 730), ('k', 3395), ('l', 5229), ('m', 3237), ('n', 7240), ('o', 4636), ('p', 1756), ('q', 7), ('r', 8956), ('s', 5805), ('t', 6862), ('u', 1979), ('v', 2332), ('w', 69), ('x', 28), ('y', 698), ('z', 34), ('å', 1190), ('æ', 872), ('ø', 939)]
CHARACTER_FREQUENCIES["is"] = [('a', 10110), ('b', 1043), ('d', 1575), ('e', 6418), ('f', 3013), ('g', 4241), ('h', 1871), ('i', 7578), ('j', 1144), ('k', 3314), ('l', 4532), ('m', 4041), ('n', 7711), ('o', 2166), ('p', 789), ('r', 8581), ('s', 5630), ('t', 4953), ('u', 4562), ('v', 2437), ('x', 46), ('y', 900), ('á', 1799), ('æ', 867), ('ð', 4393), ('é', 647), ('í', 1570), ('ö', 777), ('ó', 994), ('þ', 1455), ('ú', 613), ('ý', 228)]
CHARACTER_FREQUENCIES["fi"] = [('a', 12217), ('b', 281), ('c', 281), ('d', 1043), ('e', 7968), ('f', 194), ('g', 392), ('h', 1851), ('i', 10817), ('j', 2041), ('k', 4973), ('l', 5761), ('m', 3202), ('n', 8826), ('o', 5614), ('p', 1842), ('q', 13), ('r', 2872), ('s', 7862), ('t', 8750), ('u', 5008), ('v', 2250), ('w', 94), ('x', 31), ('y', 1745), ('z', 51), ('å', 3), ('ä', 3577), ('ö', 444)]
CHARACTER_FREQUENCIES["cs"] = [('a', 8421), ('b', 822), ('c', 740), ('d', 3475), ('e', 7562), ('f', 84), ('g', 92), ('h', 1356), ('i', 6073), ('j', 1433), ('k', 2894), ('l', 3802), ('m', 2446), ('n', 6468), ('o', 6695), ('p', 1906), ('q', 1), ('r', 4799), ('s', 5212), ('t', 5727), ('u', 2160), ('v', 5344), ('w', 16), ('x', 27), ('y', 1043), ('z', 1599), ('á', 867), ('č', 462), ('ď', 15), ('é', 633), ('ě', 1222), ('í', 1643), ('ň', 7), ('ó', 24), ('ř', 380), ('š', 688), ('ť', 6), ('ú', 45), ('ů', 204), ('ý', 995), ('ž', 721)]
CHARACTER_FREQUENCIES["hu"] = [('a', 10778), ('b', 2647), ('c', 924), ('d', 2410), ('e', 11926), ('f', 1221), ('g', 3650), ('h', 1568), ('i', 5343), ('j', 1321), ('k', 5939), ('l', 7464), ('m', 3621), ('n', 6472), ('o', 4620), ('p', 1573), ('q', 14), ('r', 5188), ('s', 7016), ('t', 9184), ('u', 1224), ('v', 2032), ('w', 72), ('x', 115), ('y', 2319), ('z', 5251), ('á', 4208), ('é', 4072), ('í', 710), ('ö', 1251), ('ó', 1145), ('ő', 1105), ('ú', 320), ('ü', 683), ('ű', 145)]
CHARACTER_FREQUENCIES["la"] = [('a', 889), ('b', 158), ('c', 399), ('d', 277), ('e', 1138), ('f', 93), ('g', 121), ('h', 69), ('i', 1144), ('k', 1), ('l', 315), ('m', 538), ('n', 628), ('o', 540), ('p', 303), ('q', 151), ('r', 667), ('s', 760), ('t', 800), ('u', 846), ('v', 96), ('x', 60), ('y', 7), ('z', 1)]


JA_CHARACTERS = []
base = [("a",u"\u3042",u"\u30A2"),("i",u"\u3044",u"\u30A4"),("u",u"\u3046",u"\u30A6"),("e",u"\u3048",u"\u30A8"),("o",u"\u304A",u"\u30AA")]
JA_CHARACTERS.extend(base)
JA_CHARACTERS.extend([("ka",u"\u304B",u"\u30AB"),("ki",u"\u304D",u"\u30AD"),("ku",u"\u304F",u"\u30AF"),("ke",u"\u3051",u"\u30B1"),("ko",u"\u3053",u"\u30B3")])
JA_CHARACTERS.extend([("ga",u"\u304C",u"\u30AC"),("gi",u"\u304E",u"\u30AE"),("gu",u"\u3050",u"\u30B0"),("ge",u"\u3052",u"\u30B2"),("go",u"\u3054",u"\u30B4")])

JA_CHARACTERS.extend([("sa",u"\u3055",u"\u30B5"),("shi",u"\u3057",u"\u30B7"),("su",u"\u3059",u"\u30B9"),("se",u"\u305B",u"\u30BB"),("so",u"\u305D",u"\u30BD")])
JA_CHARACTERS.extend([("za",u"\u3056",u"\u30B6"),("ji",u"\u3058",u"\u30B8"),("zu",u"\u305A",u"\u30BA"),("ze",u"\u305C",u"\u30BC"),("zo",u"\u305E",u"\u30BE")])

JA_CHARACTERS.extend([("ta",u"\u305F",u"\u30BF"),("chi",u"\u3061",u"\u30C1"),("tsu",u"\u3064",u"\u30C4"),("te",u"\u3066",u"\u30C6"),("to",u"\u3068",u"\u30C8")])
JA_CHARACTERS.extend([("da",u"\u3060",u"\u30C0"),("de",u"\u3067",u"\u30C7"),("do",u"\u3069",u"\u30C9")])

JA_CHARACTERS.extend([("na",u"\u306A",u"\u30CA"),("ni",u"\u306B",u"\u30CB"),("nu",u"\u306C",u"\u30CC"),("ne",u"\u306D",u"\u30CD"),("no",u"\u306E",u"\u30CE")])
JA_CHARACTERS.extend([("ha",u"\u306F",u"\u30CF"),("hi",u"\u3072",u"\u30D2"),("fu",u"\u3075",u"\u30D5"),("he",u"\u3078",u"\u30D8"),("ho",u"\u307B",u"\u30DB")])
JA_CHARACTERS.extend([("ba",u"\u3070",u"\u30D0"),("bi",u"\u3073",u"\u30D3"),("bu",u"\u3076",u"\u30D6"),("be",u"\u3079",u"\u30D9"),("bo",u"\u307C",u"\u30DC")])
JA_CHARACTERS.extend([("pa",u"\u3071",u"\u30D1"),("pi",u"\u3074",u"\u30D4"),("pu",u"\u3077",u"\u30D7"),("pe",u"\u307A",u"\u30DA"),("po",u"\u307D",u"\u30DD")])

JA_CHARACTERS.extend([("ma",u"\u307E",u"\u30DE"),("mi",u"\u307F",u"\u30DF"),("mu",u"\u3080",u"\u30E0"),("me",u"\u3081",u"\u30E1"),("mo",u"\u3082",u"\u30E2")])
JA_CHARACTERS.extend([("ya",u"\u3084",u"\u30E4"),("yu",u"\u3086",u"\u30E6"),("yo",u"\u3088",u"\u30E8")])
JA_CHARACTERS.extend([("ra",u"\u3089",u"\u30E9"),("ri",u"\u308A",u"\u30EA"),("ru",u"\u308B",u"\u30EB"),("re",u"\u308C",u"\u30EC"),("ro",u"\u308D",u"\u30ED")])
JA_CHARACTERS.extend([("wa",u"\u308F",u"\u30EF"),("wi",u"\u3090",u"\u30F0"),("we",u"\u3091",u"\u30F1"),("wo",u"\u3092",u"\u30F2")])

JA_LONG_CHARACTERS = [("kya",u"\u304D\u3083",u"\u30AD\u30E3"),("kyu",u"\u304D\u3086",u"\u30AD\u30E6"),("kyo",u"\u304D\u3088",u"\u30AD\u30E8")]
JA_LONG_CHARACTERS.extend([("gya",u"\u304E\u3083",u"\u30AE\u30E3"),("gyu",u"\u304E\u3086",u"\u30AE\u30E6"),("gyo",u"\u304E\u3088",u"\u30AE\u30E8")])
JA_LONG_CHARACTERS.extend([("sha",u"\u3057\u3083",u"\u30B7\u30E3"),("shu",u"\u3057\u3086",u"\u30B7\u30E6"),("sho",u"\u3057\u3088",u"\u30B7\u30E8")])
JA_LONG_CHARACTERS.extend([("cha",u"\u3061\u3083",u"\u30C1\u30E3"),("chu",u"\u3061\u3086",u"\u30C1\u30E6"),("cho",u"\u3061\u3088",u"\u30C1\u30E8")])
JA_LONG_CHARACTERS.extend([("nya",u"\u306B\u3083",u"\u30CB\u30E3"),("nyu",u"\u306B\u3086",u"\u30CB\u30E6"),("nyo",u"\u306B\u3088",u"\u30CB\u30E8")])
JA_LONG_CHARACTERS.extend([("hya",u"\u3072\u3083",u"\u30D2\u30E3"),("hyu",u"\u3072\u3086",u"\u30D2\u30E6"),("hyo",u"\u3072\u3088",u"\u30D2\u30E8")])
JA_LONG_CHARACTERS.extend([("bya",u"\u3073\u3083",u"\u30D3\u30E3"),("byu",u"\u3073\u3086",u"\u30D3\u30E6"),("byo",u"\u3073\u3088",u"\u30D3\u30E8")])
JA_LONG_CHARACTERS.extend([("pya",u"\u3074\u3083",u"\u30D4\u30E3"),("pyu",u"\u3074\u3086",u"\u30D4\u30E6"),("pyo",u"\u3074\u3088",u"\u30D4\u30E8")])
JA_LONG_CHARACTERS.extend([("mya",u"\u307F\u3083",u"\u30DF\u30E3"),("myu",u"\u307F\u3086",u"\u30DF\u30E6"),("myo",u"\u307F\u3088",u"\u30DF\u30E8")])
JA_LONG_CHARACTERS.extend([("rya",u"\u308A\u3083",u"\u30EA\u30E3"),("ryu",u"\u308A\u3086",u"\u30EA\u30E6"),("ryo",u"\u308A\u3088",u"\u30EA\u30E8")])
JA_LONG_CHARACTERS.extend([("ja",u"\u3058\u3083",u"\u30B8\u30E3"),("ju",u"\u3058\u3086",u"\u30B8\u30E6"),("jo",u"\u3058\u3088",u"\u30B8\u30E8")])
...
def randomword_ja(l=5):
    def modif(x, double, n):
        ...
        return x
    def choice(): return random.choice(JA_LONG_CHARACTERS if floatrng(0.2) else JA_CHARACTERS)
    word = choice()[0]
...
def japanese_latin(string):
    for x,hx,kx in JA_LONG_CHARACTERS+JA_CHARACTERS: string = string.replace(hx, x).replace(kx, x)
    findings = re.findall(r"(?:[\u30C3\u3063][stkp])|(?:\u30A5w)|(?:\u30E0m)|(?:\u30F3n)", string)
    for x in findings: string = string.replace(x, x[1]*2)
    findings = re.findall(r"[aiueo]\u30FC", string)
    for x in findings: string = string.replace(x, x[0]*2)
    return string.replace(u"\u3093", "n").replace(u"\u30F3", "n")
def latin_hiragana(string):
    l = JA_CHARACTERS[5:]
    for x,hx,_ in JA_LONG_CHARACTERS+l:
        if x[1] in "ie":
    ...
    for x,hx,_ in JA_CHARACTERS[:5]: string = string.replace(x, hx)
    return string.replace("n", u"\u3093")
def latin_katakana(string):
    findings = re.findall(r"(?:aa)|(?:ii)|(?:uu)|(?:ee)|(?:oo)", string) # [aiueo]
    for x in findings: string = string.replace(x, x[0]+u"\u30FC")
    findings = re.findall(r"(?:ww[aiueo])", string)
    for x in findings: string = string.replace(x, u"\u30A5"+x[1:])
    findings = re.findall(r"(?:ss)(?:tt)(?:pp)(?:kk)[aiueo]", string) # [stpk]
    for x in findings: string = string.replace(x, u"\u3063"+x[1:])
    findings = re.findall(r"(?:nn[aiueo])|(?:mm[aiueo])", string)
    for x in findings: string = string.replace(x, u"\u30F3"+x[1:])
    l = JA_CHARACTERS[5:]
    for x,_,kx in JA_LONG_CHARACTERS+l: string = string.replace(x, kx)
    for x,_,kx in JA_CHARACTERS[:5]: string = string.replace(x, kx)
    return string
def randomstring_word(l=5, lan="en"): # word-like string
    ...
    if lan=="ja": word = randomword_ja(l-1)
        ...
        soft = list(zip(*[x for x in CHARACTER_FREQUENCIES[lan] if x[0] in VOWELS]))
        soft = "".join(np.array(soft[0])[rng_bulk(soft[1], 100)].tolist())
        hard = list(zip(*[x for x in CHARACTER_FREQUENCIES[lan] if x[0] in CONSONANTS]))
        hard = "".join(np.array(hard[0])[rng_bulk(hard[1], 100)].tolist())
        if 0: # lan in additional CONSONANTS:
            special = list(zip(*[x for x in CHARACTER_FREQUENCIES[lan] if x[0] in CONSONANTS]))
...
def adj_adv(x): # english adverb from adjective
...
def adv_adj(x): # english adjective from adverb
...
class IMPERIAL_CONVERSION:
    re_len_units = r"(?:th|mil)|(?:in|\″)|hh|(?:ft|\′)|yd|ch|fur|mi|lea|ftm|nmi"
    len_table = { # -> meters
        "th": 0.0000254,
        "mil": 0.0000254,
        "in": 0.0254,
    ...
    re_vol_units = r"fl\soz|gi|pt|qt|gal"
    vol_table = { # -> liters
        "fl oz": .0284130625,
        "gil": 0.1420653125,
        "pt": 0.56826125,
    ...
    re_mass_units = r"gr|dr|oz|lb|st|qr|qtr|cwt|t"
    mass_table = { # -> grams
        "gr": 0.06479891,
        "dr": 1.7718451953125,
        "oz": 28.349523125,
    ...
    regex = rf"(((?:(?:\d*)\.(?:\d*))?(?:\d*\.\d*)|(?:\d+))\s?({re_len_units}|{re_vol_units}|{re_mass_units}))"

def imperial_to_SIvalues(string):
    fs = re.findall(IMPERIAL_CONVERSION.regex, string)
    newstring = string
    for x in fs:
        x, value, unit = x
        value = float(value)
        meters = value*IMPERIAL_CONVERSION.len_table.get(unit, 0)
        if meters: newstring = newstring.replace(x, f"{meters}m", 1)
        else:
            liters = value*IMPERIAL_CONVERSION.vol_table.get(unit, 0)
            if liters: newstring = newstring.replace(x, f"{liters}l", 1)
            else:
                grams = value*IMPERIAL_CONVERSION.mass_table.get(unit, 0)
...
def fraction(x, y):
    ...
    # 2080, ...
    def upper(i):
        return (0xb9 if i==1 else 0xb0+i) if 0<i<4 else 0x2070+i
    sign = ""
    if (x<0)!=(y<0): sign = "-"
    x = "".join([chr(int(hex(upper(int(xx))), 16)) for xx in str(abs(x))])
    y = "".join([chr(int(hex(0x2080+int(xx)), 16)) for xx in str(abs(y))])
    return sign+x+chr(0x2044)+y
...
def float_accuracy(string):
    accuracy = None
    for f in RE_FLOATS.findall(string):
        acc = len(f.split(".", 1)[1])
        if accuracy is not None: accuracy = min(accuracy, acc)
        else: accuracy = acc
    return accuracy

def int_accuracy(string):
    accuracy = None
    for i in RE_INTEGERS.findall(string):
...
def read_morse(t):
    ...
    for x in t:
        if x in ".-": mem += x
            ...
            tt += decode(mem)
            mem = ""
    tt += decode_num(mem) if len(mem)==5  else decode(mem)
    return tt
